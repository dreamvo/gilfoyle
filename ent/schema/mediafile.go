...
func (MediaFile) Fields() []ent.Field {
	return []ent.Field{
		...
		field.Uint16("resolution_width").Min(1).Max(15360),
		field.Uint16("resolution_height").Min(1).Max(8640),
		...
		field.Enum("status").Values(MediaStatusPending, MediaStatusProcessing, MediaStatusReady, MediaStatusErrored),
