...
func (mq *MediaQuery) QueryEvents() *MediaEventsQuery {
	query := &MediaEventsQuery{config: mq.config}
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		if err := mq.prepareQuery(ctx); err != nil {
			return nil, err
		}
...
func (mq *MediaQuery) WithEvents(opts ...func(*MediaEventsQuery)) *MediaQuery {
	query := &MediaEventsQuery{config: mq.config}
	for _, opt := range opts {
		opt(query)
	}
...
func (mq *MediaQuery) sqlAll(ctx context.Context) ([]*Media, error) {
	...
	if query := mq.withEvents; query != nil {
		...
		for i := range nodes {
			fks = append(fks, nodes[i].ID)
			nodeids[nodes[i].ID] = nodes[i]
			nodes[i].Edges.Events = []*MediaEvents{}
		}
		query.withFKs = true
		query.Where(predicate.MediaEvents(func(s *sql.Selector) {
			s.Where(sql.InValues(media.EventsColumn, fks...))
		}))
		neighbors, err := query.All(ctx)
		if err != nil {
			return nil, err
...
func (mgb *MediaGroupBy) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{media.Label}
	default:
		err = fmt.Errorf("ent: MediaGroupBy.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (mgb *MediaGroupBy) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{media.Label}
	default:
		err = fmt.Errorf("ent: MediaGroupBy.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (mgb *MediaGroupBy) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{media.Label}
	default:
		err = fmt.Errorf("ent: MediaGroupBy.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (mgb *MediaGroupBy) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{media.Label}
	default:
		err = fmt.Errorf("ent: MediaGroupBy.Bools returned %d results when one was expected", len(v))
	}
	return
}
...
func (ms *MediaSelect) String(ctx context.Context) (_ string, err error) {
	...
	case 0:
		err = &NotFoundError{media.Label}
	default:
		err = fmt.Errorf("ent: MediaSelect.Strings returned %d results when one was expected", len(v))
	}
	return
}
...
func (ms *MediaSelect) Int(ctx context.Context) (_ int, err error) {
	...
	case 0:
		err = &NotFoundError{media.Label}
	default:
		err = fmt.Errorf("ent: MediaSelect.Ints returned %d results when one was expected", len(v))
	}
	return
}
...
func (ms *MediaSelect) Float64(ctx context.Context) (_ float64, err error) {
	...
	case 0:
		err = &NotFoundError{media.Label}
	default:
		err = fmt.Errorf("ent: MediaSelect.Float64s returned %d results when one was expected", len(v))
	}
	return
}
...
func (ms *MediaSelect) Bool(ctx context.Context) (_ bool, err error) {
	...
	case 0:
		err = &NotFoundError{media.Label}
	default:
		err = fmt.Errorf("ent: MediaSelect.Bools returned %d results when one was expected", len(v))
	}
	return
}
